                          ...
                          onPressed: () async {
                            ...
                            if (emailcontroller.text.isEmpty) {
                              setState(() {
                                isLoading = false;
                                message =
                                    "Please enter your email."; // Stop loading if validation fails
                              });
                              showCustomSnackBar(
                                context,
                            ...
                            if (passwordcontroller.text.isEmpty) {
                              setState(() {
                                isLoading = false;
                                message =
                                    "Please enter a password."; // Stop loading if validation fails
                              });
                              showCustomSnackBar(
                                context,
                            ...
                            if (confirmpasswordcontroller.text.isEmpty) {
                              setState(() {
                                isLoading = false;
                                message =
                                    "Please confirm your password."; // Stop loading if validation fails
                              });
                              showCustomSnackBar(
                                context,
                            ...
                            if (passwordcontroller.text !=
                              ...
                              setState(() {
                                isLoading = false;
                                message =
                                    "Passwords do not match"; // Stop loading if validation fails
                              });
                              showCustomSnackBar(
                                context,
...
// داخل الدالة onPressed
                            if (!EmailValidator.validate(
                              ...
                              setState(() {
                                isLoading = false;
                                message =
                                    'Please enter a valid email address.'; // Stop loading if validation fails
                              });
                              showCustomSnackBar(
                                context,
                  ...
                  if (message != null)
                    Padding(
                      ...
                      child: Text(
                        message!,
                        style: TextStyle(
                          color: message == 'User created successfully!'
                              ? Colors.green
                              : Colors.red,
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
